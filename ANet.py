...
def main_alexnet(folder,filename,size_batch,size_epoch,rate_learn):
    ...
    csv_logger = keras.callbacks.CSVLogger("alexnet_result.csv", append=True)
    ...
    model.compile(loss='categorical_crossentropy',
                  loss_weights=0.3, optimizer=keras.optimizers.SGD(lr=rate_learn, momentum=0.9, nesterov=False),
                  metrics=['accuracy'])
